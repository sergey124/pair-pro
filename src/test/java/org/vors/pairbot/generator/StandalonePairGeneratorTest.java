...
import org.vors.pairbot.generator.standalone.StandalonePairGenerator;
import org.vors.pairbot.model.Person;

import java.util.*;

public class StandalonePairGeneratorTest {
    private final Logger LOG = LoggerFactory.getLogger(getClass());

    private StandalonePairGenerator systemUnderTest = new StandalonePairGenerator();
